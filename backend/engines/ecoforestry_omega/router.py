"""
ENGINE_ECOFORESTRY_Ω — Router FastAPI squelette (inert)
...
router = APIRouter(prefix="/api/v7-ultime/ecoforestry/compute", tags=["ENGINE_ECOFORESTRY_Ω_X199_PREPARATOIRE"])
