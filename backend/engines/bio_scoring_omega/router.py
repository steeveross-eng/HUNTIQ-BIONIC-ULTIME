"""
ENGINE_BIO_SCORING_Ω — Router FastAPI squelette (inert)
...
router = APIRouter(prefix="/api/v7-ultime/bio-scoring/compute", tags=["ENGINE_BIO_SCORING_Ω_X199_PREPARATOIRE"])
