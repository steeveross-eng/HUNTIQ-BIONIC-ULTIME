"""
ENGINE_WILDLIFE_BEHAVIOR_Ω — Router FastAPI squelette (inert)
...
router = APIRouter(prefix="/api/v7-ultime/wildlife-behavior/compute", tags=["ENGINE_WILDLIFE_BEHAVIOR_Ω_X199_PREPARATOIRE"])
