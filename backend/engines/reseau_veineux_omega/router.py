"""
ENGINE_RESEAU_VEINEUX_Ω — Router FastAPI squelette (inert)
...
router = APIRouter(prefix="/api/v7-ultime/reseau-veineux/compute", tags=["ENGINE_RESEAU_VEINEUX_Ω_X199_PREPARATOIRE"])
