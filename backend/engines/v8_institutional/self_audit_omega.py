...
_TEST_SUITES = [
    ...
    # Phase XI-SUPRA-D — Route stable /territoire-capture-mode
    # (test_lep_ingestion_omega retiré : EXCLUDE_LAYER LEP_CRITICAL_HABITAT_NATIONAL
    #  — directive STEEVE-MAX 2026-04-20 STATUS OFFICIAL)
