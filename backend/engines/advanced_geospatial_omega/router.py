"""
ENGINE_ADVANCED_GEOSPATIAL_Ω — Router FastAPI squelette (inert)
...
router = APIRouter(prefix="/api/v7-ultime/advanced-geospatial/compute", tags=["ENGINE_ADVANCED_GEOSPATIAL_Ω_X199_PREPARATOIRE"])
