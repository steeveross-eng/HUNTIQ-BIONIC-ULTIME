...
import {
  Droplets, FlaskConical, MapPin, AlertTriangle,
  ShoppingCart, DollarSign, BookOpen, Package,
  Scale, BarChart3, ArrowRight, ChevronDown, ChevronUp,
  Mountain, Plus, X, Loader2,
  TreeDeciduous, Shield, ClipboardList, Info
} from 'lucide-react';
