...
// V9-INSTITUTIONNEL PARAMETERS — PHASE-E RENDU-Ω INTÉGRAL (ordre Commandant 2026-04-28)
// PURGE LEGACY : densité réduite drastiquement pour libérer la lisibilité Ω.
const PARTICLE_COUNT = 600;       // PURGE Ω : 2500 → 600 (-76% encombrement)
const MAX_OPACITY = 0.42;         // PURGE Ω : 0.90 → 0.42 (couches Ω prioritaires)
const TRAIL_COLOR = '144, 202, 249'; // #90CAF9
const HEAD_COLOR = '220, 240, 255';
const ARROW_LENGTH = 5;           // PURGE Ω : 6 → 5
const ARROW_WIDTH = 2;            // PURGE Ω : 3 → 2
const TRAIL_LENGTH = 5;           // PURGE Ω : 10 → 5 (-50% segments)
const LINE_WIDTH = 1.2;           // PURGE Ω : 1.8 → 1.2 (atténuation)
