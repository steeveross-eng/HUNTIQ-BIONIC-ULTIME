...
// PURGE-V6-ANTI-DUPLICATION-A-Omega: BLOC 3 animation PURGE (pulse-reloc supprime)
...
const StandsMapLayer = ({
  ...
  // PURGE-V6: relocationLayerRef removed (BLOC 3 purged)
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      // PURGE-V6-ANTI-DUPLICATION-A-Omega: BLOC 3 RELOCALISATION V6 NEUTRALISE
      // Relocalisation desormais geree par PhaseALayerV8 + usePhaseAV8 (V8 natif)
      // Ancien code: appel /api/v1/relocation/evaluate SUPPRIME
    } catch (err) {
  ...
  // PURGE-V6-ANTI-DUPLICATION-A-Omega: BLOC 3 V6 RELOCALISATION SUPPRIME
  // Toute la logique de relocalisation est desormais dans PhaseALayerV8.jsx (V8 natif)
