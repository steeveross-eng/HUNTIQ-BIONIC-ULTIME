...
- **Emitted at**: 2026-06-06T19:00:18.292265+00:00

---

```
══════════════════════════════════════════════════════════════════════════════
  RAPPORT_QC_PROGRESS_Ω · 2026-06-06T19:00:18.222680+00:00
  Phase     : PHASE_2_QC_LIMITROPHES
══════════════════════════════════════════════════════════════════════════════

§ A · LIMITROPHES (priority=1) — CIBLE PHASE 2 ACTIVE
  Tuiles uploadées R2  : 90609
  Cells uniques        : 1294 / 2292
  Couverture cells     : 56.46%
...
§ B · DÉTAIL PAR LABEL
  ...
  OUTAOUAIS_NORD_LIMITROPHE                 :    7776 tuiles ·   136 cells
  OUTAOUAIS_RF_PAPINEAU_VERENDRYE_SUD       :    3195 tuiles ·    45 cells
  OUT_OF_QC                                 :     210 tuiles ·    20 cells
  QC_SUD_OTHER                              :     252 tuiles ·    21 cells

§ C · DISTRIBUTION PAR PRIORITÉ
  priority=1:   90609 tuiles
  priority=2:   47538 tuiles
