...
```bash
curl -s "https://ultime-preview.preview.emergentagent.com/api/v20/territoire/bundle?lat=48.206657&lon=-68.382422&species=chevreuil&month=10&hour=7&wind_deg=225&wind_speed=15"
```
...
```bash
curl https://ultime-preview.preview.emergentagent.com/api/v20/audit/v5-compliance-live?lat=48.206657&lon=-68.382422&species=chevreuil
```
**Attendu** : `status=PASS, violations=0, n_corridors=7, n_backbones=2, n_subnets=5`

### 6.4 · Audit circuit breaker
```bash
curl https://ultime-preview.preview.emergentagent.com/api/v20/audit/v5-monitor-stats
```
